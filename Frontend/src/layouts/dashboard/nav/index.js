...
const StyledAccount = styled('div')(({ theme }) => ({
  ...
  // backgroundColor: alpha(theme.palette.grey[500], 0.12),
  background: `linear-gradient(45deg, #ff9e4a, #fcd206)`,
}));
      ...
      <Box sx={{ mb: 5, mx: 2.5 }}>
        <Link underline="none">
          <StyledAccount>
            ...
            <Box sx={{ ml: 2 }}>
              <Typography variant="subtitle2" sx={{ color: 'text.primary' }}  class="font-elegant-font font-bold">
              <span className="text-xl ">{user.user_name.charAt(0).toUpperCase()}</span>
